...
class Car:
    ...
    def drive(self, miles_traveled:float|int):
        ...
        self._current_gas_in_the_tank -= min(total_used_gallons, self._current_gas_in_the_tank)


my_honda_civic = Car(make="honda", model="civic", color="orange")
your_ferrari = Car(make="ferrari", model="Porsche", color="yellow")
your_honda_civic = Car(make="honda", model="civic", color="orange")
print(my_honda_civic)
print(your_ferrari)
print(your_ferrari == 5)
