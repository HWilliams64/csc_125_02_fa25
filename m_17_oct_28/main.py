...
print("I parked my honda")
my_honda_civic_ticket = my_garage.park(my_honda_civic)
sleep(1)
print(my_garage)

print("You parked your porsche")
your_porsche_ticket = my_garage.park(your_porsche)
sleep(2)
print(my_garage)

print("You parked your ferrari")
your_ferrari_ticket = my_garage.park(your_ferrari)
sleep(2)
print(my_garage)

fee, car, message = my_garage.retrieve(my_honda_civic_ticket)
print(f"${fee}, did I receive my car? {bool(car)}, response \"{message}\"")
